...
class ThreeSwipers extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(ThreeSwipersControllers());
    return SizedBox(
      ...
      child: const Stack(
        ...
        children: [
          SwiperContainer(index: Containers.first,iconName: 'meals.png',name: 'وجبات',),
          SwiperContainer(index: Containers.second,iconName: 'grocery.png',name: 'منتجات'),
          SwiperContainer(index: Containers.third,iconName: 'food.png',name: 'طعام'),
        ],
      ),
    );
  }
